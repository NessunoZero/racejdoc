...
function main() {
    const argsObj = yargs_1.default
        ...
        .usage(`A cli to generate a pdf from two file, template eta and data yml\n
    ...
    const dataObj = (0, yaml_1.parse)((0, fs_1.readFileSync)((0, path_1.resolve)(argsObjTyped.d), { encoding: "utf8" }));
    const eta = new eta_1.Eta();
    eta.loadTemplate("@root", (0, fs_1.readFileSync)((0, path_1.resolve)(argsObjTyped.t), { encoding: "utf8" }));
    const htmlPage = eta.render("@root", dataObj);
    if (argsObjTyped.w) {
        (0, fs_1.writeFileSync)((0, path_1.resolve)(argsObjTyped.o), htmlPage);
    }
    else {
        (0, puppeteer_1.launch)({ headless: "new" }).then((browser) => __awaiter(this, void 0, void 0, function* () {
